...
#v6 (2020/03/17): modified to run on FNAL by Taritree, precut parameters can be set with arguments
...
_shower1_gap_U = MakeTreeBranch(outTree,'shower1_gap_U','int')
_shower1_gap_V = MakeTreeBranch(outTree,'shower1_gap_V','int')
_shower1_gap_Y = MakeTreeBranch(outTree,'shower1_gap_Y','int')
_shower1_dir_3d_X = MakeTreeBranch(outTree,'shower1_dir_3d_X','float')
_shower1_dir_3d_Y = MakeTreeBranch(outTree,'shower1_dir_3d_Y','float')
_shower1_dir_3d_Z = MakeTreeBranch(outTree,'shower1_dir_3d_Z','float')
_shower1_dir_2d_U = MakeTreeBranch(outTree,'shower1_dir_2d_U','float')
_shower1_dir_2d_V = MakeTreeBranch(outTree,'shower1_dir_2d_V','float')
_shower1_dir_2d_Y = MakeTreeBranch(outTree,'shower1_dir_2d_Y','float')
_shower1_op_2d_U = MakeTreeBranch(outTree,'shower1_op_2d_U','float')
_shower1_op_2d_V = MakeTreeBranch(outTree,'shower1_op_2d_V','float')
_shower1_op_2d_Y = MakeTreeBranch(outTree,'shower1_op_2d_Y','float')
_shower1_start_2d_U_X = MakeTreeBranch(outTree,'shower1_start_2d_U_X','int')
_shower1_start_2d_U_Y = MakeTreeBranch(outTree,'shower1_start_2d_U_Y','int')
_shower1_start_2d_U_Z = MakeTreeBranch(outTree,'shower1_start_2d_U_Z','int')
_shower1_start_2d_V_X = MakeTreeBranch(outTree,'shower1_start_2d_V_X','int')
_shower1_start_2d_V_Y = MakeTreeBranch(outTree,'shower1_start_2d_V_Y','int')
_shower1_start_2d_V_Z = MakeTreeBranch(outTree,'shower1_start_2d_V_Z','int')
_shower1_start_2d_Y_X = MakeTreeBranch(outTree,'shower1_start_2d_Y_X','int')
_shower1_start_2d_Y_Y = MakeTreeBranch(outTree,'shower1_start_2d_Y_Y','int')
_shower1_start_2d_Y_Z = MakeTreeBranch(outTree,'shower1_start_2d_Y_Z','int')
_shower1_impact = MakeTreeBranch(outTree,'_shower1_impact','float')
...
_shower2_gap_U = MakeTreeBranch(outTree,'shower2_gap_U','int')
_shower2_gap_V = MakeTreeBranch(outTree,'shower2_gap_V','int')
_shower2_gap_Y = MakeTreeBranch(outTree,'shower2_gap_Y','int')
_shower2_dir_3d_X = MakeTreeBranch(outTree,'shower2_dir_3d_X','float')
_shower2_dir_3d_Y = MakeTreeBranch(outTree,'shower2_dir_3d_Y','float')
_shower2_dir_3d_Z = MakeTreeBranch(outTree,'shower2_dir_3d_Z','float')
_shower2_dir_2d_U = MakeTreeBranch(outTree,'shower2_dir_2d_U','float')
_shower2_dir_2d_V = MakeTreeBranch(outTree,'shower2_dir_2d_V','float')
_shower2_dir_2d_Y = MakeTreeBranch(outTree,'shower2_dir_2d_Y','float')
_shower2_op_2d_U = MakeTreeBranch(outTree,'shower2_op_2d_U','float')
_shower2_op_2d_V = MakeTreeBranch(outTree,'shower2_op_2d_V','float')
_shower2_op_2d_Y = MakeTreeBranch(outTree,'shower2_op_2d_Y','float')
_shower2_start_2d_U_X = MakeTreeBranch(outTree,'shower2_start_2d_U_X','int')
_shower2_start_2d_U_Y = MakeTreeBranch(outTree,'shower2_start_2d_U_Y','int')
_shower2_start_2d_U_Z = MakeTreeBranch(outTree,'shower2_start_2d_U_Z','int')
_shower2_start_2d_V_X = MakeTreeBranch(outTree,'shower2_start_2d_V_X','int')
_shower2_start_2d_V_Y = MakeTreeBranch(outTree,'shower2_start_2d_V_Y','int')
_shower2_start_2d_V_Z = MakeTreeBranch(outTree,'shower2_start_2d_V_Z','int')
_shower2_start_2d_Y_X = MakeTreeBranch(outTree,'shower2_start_2d_Y_X','int')
_shower2_start_2d_Y_Y = MakeTreeBranch(outTree,'shower2_start_2d_Y_Y','int')
_shower2_start_2d_Y_Z = MakeTreeBranch(outTree,'shower2_start_2d_Y_Z','int')
_shower2_impact = MakeTreeBranch(outTree,'_shower2_impact','float')
_shower_alpha = MakeTreeBranch(outTree,'_shower_alpha','float')
_pi0mass = MakeTreeBranch(outTree,'_pi0mass','float')
...
def clear_vertex():
    ...
    _shower1_gap_U = int(-9999)
    _shower1_gap_V = int(-9999)
    _shower1_gap_Y = int(-9999)
    _shower1_dir_3d_X = float(-9999)
    _shower1_dir_3d_Y  = float(-9999)
    _shower1_dir_3d_Z = float(-9999)
    _shower1_dir_2d_U = float(-9999)
    _shower1_dir_2d_V = float(-9999)
    _shower1_dir_2d_Y = float(-9999)
    _shower1_op_2d_U = float(-9999)
    _shower1_op_2d_V = float(-9999)
    _shower1_op_2d_Y = float(-9999)
    _shower1_start_2d_U_X = int(-9999)
    _shower1_start_2d_U_Y = int(-9999)
    _shower1_start_2d_U_Z = int(-9999)
    _shower1_start_2d_V_X  = int(-9999)
    _shower1_start_2d_V_Y = int(-9999)
    _shower1_start_2d_V_Z  = int(-9999)
    _shower1_start_2d_Y_X = int(-9999)
    _shower1_start_2d_Y_Y = int(-9999)
    _shower1_start_2d_Y_Z = int(-9999)
    _shower1_impact = float(-9999)
    _shower2_gap_U = int(-9999)
    _shower2_gap_V = int(-9999)
    _shower2_gap_Y = int(-9999)
    _shower2_dir_3d_X = float(-9999)
    _shower2_dir_3d_Y = float(-9999)
    _shower2_dir_3d_Z  = float(-9999)
    _shower2_dir_2d_U = float(-9999)
    _shower2_dir_2d_V = float(-9999)
    _shower2_dir_2d_Y = float(-9999)
    _shower2_op_2d_U  = float(-9999)
    _shower2_op_2d_V = float(-9999)
    _shower2_op_2d_Y = float(-9999)
    _shower2_start_2d_U_X = int(-9999)
    _shower2_start_2d_U_Y = int(-9999)
    _shower2_start_2d_U_Z = int(-9999)
    _shower2_start_2d_V_X = int(-9999)
    _shower2_start_2d_V_Y = int(-9999)
    _shower2_start_2d_V_Z = int(-9999)
    _shower2_start_2d_Y_X = int(-9999)
    _shower2_start_2d_Y_Y = int(-9999)
    _shower2_start_2d_Y_Z = int(-9999)
    _shower2_impact = float(-9999)
    _shower_alpha = float(-9999)
    _pi0mass = float(-9999)
...
for indo,ev in enumerate(TrkTree):
    ...
    _shower1_gap_U[0]     = int(vtxShowerData["shower_gap"][0])       if PassSimpleCuts and PassShowerReco else -99999
    _shower1_gap_V[0]     = int(vtxShowerData["shower_gap"][1])       if PassSimpleCuts and PassShowerReco else -99999
    _shower1_gap_Y[0]     = int(vtxShowerData["shower_gap"][2])       if PassSimpleCuts and PassShowerReco else -99999
    _shower1_dir_3d_X[0]  = float(vtxShowerData["shower_direction_3d"][0])       if PassSimpleCuts and PassShowerReco else -99999
    _shower1_dir_3d_Y[0]  = float(vtxShowerData["shower_direction_3d"][1])       if PassSimpleCuts and PassShowerReco else -99999
    _shower1_dir_3d_Z[0]  = float(vtxShowerData["shower_direction_3d"][2])       if PassSimpleCuts and PassShowerReco else -99999
    _shower1_dir_2d_U[0]  = float(vtxShowerData["shower_direction_2d"][0])       if PassSimpleCuts and PassShowerReco else -99999
    _shower1_dir_2d_V[0]  = float(vtxShowerData["shower_direction_2d"][1])       if PassSimpleCuts and PassShowerReco else -99999
    _shower1_dir_2d_Y[0]  = float(vtxShowerData["shower_direction_2d"][2])       if PassSimpleCuts and PassShowerReco else -99999
    _shower1_op_2d_U[0]   = float(vtxShowerData["shower_opening_2d"][0])       if PassSimpleCuts and PassShowerReco else -99999
    _shower1_op_2d_V[0]   = float(vtxShowerData["shower_opening_2d"][1])       if PassSimpleCuts and PassShowerReco else -99999
    _shower1_op_2d_Y[0]   = float(vtxShowerData["shower_opening_2d"][2])       if PassSimpleCuts and PassShowerReco else -99999
    _shower1_start_2d_U_X[0] = int(vtxShowerData["shower_start_2d"][0])       if PassSimpleCuts and PassShowerReco else -99999
    _shower1_start_2d_U_Y[0] = int(vtxShowerData["shower_start_2d"][0])       if PassSimpleCuts and PassShowerReco else -99999
    _shower1_start_2d_U_Z[0] = int(vtxShowerData["shower_start_2d"][0])       if PassSimpleCuts and PassShowerReco else -99999
    _shower1_start_2d_V_X[0] = int(vtxShowerData["shower_start_2d"][1])       if PassSimpleCuts and PassShowerReco else -99999
    _shower1_start_2d_V_Y[0] = int(vtxShowerData["shower_start_2d"][1])       if PassSimpleCuts and PassShowerReco else -99999
    _shower1_start_2d_V_Z[0] = int(vtxShowerData["shower_start_2d"][1])       if PassSimpleCuts and PassShowerReco else -99999
    _shower1_start_2d_Y_X[0] = int(vtxShowerData["shower_start_2d"][2])       if PassSimpleCuts and PassShowerReco else -99999
    _shower1_start_2d_Y_Y[0] = int(vtxShowerData["shower_start_2d"][2])       if PassSimpleCuts and PassShowerReco else -99999
    _shower1_start_2d_Y_Z[0] = int(vtxShowerData["shower_start_2d"][2])       if PassSimpleCuts and PassShowerReco else -99999
    _shower1_impact[0]   = float(vtxShowerData["shower_impact"][0])       if PassSimpleCuts and PassShowerReco else -99999
    _shower2_gap_U[0]    = int(vtxShowerData["secondshower_gap"][0])       if PassSimpleCuts and PassShowerReco else -99999
    _shower2_gap_V[0]    = int(vtxShowerData["secondshower_gap"][1])       if PassSimpleCuts and PassShowerReco else -99999
    _shower2_gap_Y[0]    = int(vtxShowerData["secondshower_gap"][2])       if PassSimpleCuts and PassShowerReco else -99999
    _shower2_dir_3d_X[0] = float(vtxShowerData["secondshower_direction_3d"][0])       if PassSimpleCuts and PassShowerReco else -99999
    _shower2_dir_3d_Y[0] = float(vtxShowerData["secondshower_direction_3d"][1])       if PassSimpleCuts and PassShowerReco else -99999
    _shower2_dir_3d_Z[0] = float(vtxShowerData["secondshower_direction_3d"][2])       if PassSimpleCuts and PassShowerReco else -99999
    _shower2_dir_2d_U[0] = float(vtxShowerData["secondshower_direction_2d"][0])       if PassSimpleCuts and PassShowerReco else -99999
    _shower2_dir_2d_V[0] = float(vtxShowerData["secondshower_direction_2d"][1])       if PassSimpleCuts and PassShowerReco else -99999
    _shower2_dir_2d_Y[0] = float(vtxShowerData["secondshower_direction_2d"][2])       if PassSimpleCuts and PassShowerReco else -99999
    _shower2_op_2d_U[0]  = float(vtxShowerData["secondshower_opening_2d"][0])       if PassSimpleCuts and PassShowerReco else -99999
    _shower2_op_2d_V[0]  = float(vtxShowerData["secondshower_opening_2d"][1])       if PassSimpleCuts and PassShowerReco else -99999
    _shower2_op_2d_Y[0]  = float(vtxShowerData["secondshower_opening_2d"][2])       if PassSimpleCuts and PassShowerReco else -99999
    _shower2_start_2d_U_X[0] = int(vtxShowerData["secondshower_start_2d"][0])       if PassSimpleCuts and PassShowerReco else -99999
    _shower2_start_2d_U_Z[0] = int(vtxShowerData["secondshower_start_2d"][0])       if PassSimpleCuts and PassShowerReco else -99999
    _shower2_start_2d_U_Y[0] = int(vtxShowerData["secondshower_start_2d"][0])       if PassSimpleCuts and PassShowerReco else -99999
    _shower2_start_2d_V_X[0] = int(vtxShowerData["secondshower_start_2d"][1])       if PassSimpleCuts and PassShowerReco else -99999
    _shower2_start_2d_V_Y[0] = int(vtxShowerData["secondshower_start_2d"][1])       if PassSimpleCuts and PassShowerReco else -99999
    _shower2_start_2d_V_Z[0] = int(vtxShowerData["secondshower_start_2d"][1])       if PassSimpleCuts and PassShowerReco else -99999
    _shower2_start_2d_Y_X[0] = int(vtxShowerData["secondshower_start_2d"][2])       if PassSimpleCuts and PassShowerReco else -99999
    _shower2_start_2d_Y_Y[0] = int(vtxShowerData["secondshower_start_2d"][2])       if PassSimpleCuts and PassShowerReco else -99999
    _shower2_start_2d_Y_Z[0] = int(vtxShowerData["secondshower_start_2d"][2])       if PassSimpleCuts and PassShowerReco else -99999
    _shower2_impact[0]  = float(vtxShowerData["secondshower_impact"][0])       if PassSimpleCuts and PassShowerReco else -99999
    _shower_alpha[0]    = float(vtxShowerData["opening_angle_3d"][0])       if PassSimpleCuts and PassShowerReco else -99999
    _pi0mass[0]         = float(vtxShowerData["pi0mass"][0])       if PassSimpleCuts and PassShowerReco else -99999
