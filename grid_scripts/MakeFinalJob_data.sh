...
do
  ...
  echo Name
  echo ${FILE_NAME}
  python MakeFinalVertexFiles-prime-dlmerged_NUMUONLY.py ${THIS_FILE_ID} ${CALIB} ${RELATIVE_PATH}/ > test_outs/log.log
  echo ${RELATIVE_PATH} >> test_outs/successes_mine.txt
done
