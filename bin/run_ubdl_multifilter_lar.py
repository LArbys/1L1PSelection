...
#parser.add_argument('-f','--filter-type',required=True,type=str,nargs="+",help="Filter type")
...
import ubdlana
from ubdlana.dl_multi_filter import DLMultiFilter
import ROOT as rt
