...
for indo,ev in enumerate(TrkTree):
    ...
    if PassSimpleCuts:
        ...
        print("Checking MC?!")
        print()
        for i in xrange(len(dqdx_v_uncalibrated)):
            print("Original Uncal:", dqdx_v_uncalibrated[i])
            print("Original Cal:", dqdx_v_calibrated[i])
        if IsMC:
            print("IS MC")
        ...
        for i in xrange(0,len(dqdx_v_uncalibrated)):
            print("Calibrated",dqdx_v_calibrated[i])
            print("Uncalibrated",dqdx_v_uncalibrated[i])
            print("CorrectionFactor",CorrectionFactor(vtxX,vtxY,vtxZ,vtxTheta_v[i],vtxPhi_v[i],length_v[i],calibMap_v))
            print(dqdx_v_uncalibrated[i] * CorrectionFactor(vtxX,vtxY,vtxZ,vtxTheta_v[i],vtxPhi_v[i],length_v[i],calibMap_v))
