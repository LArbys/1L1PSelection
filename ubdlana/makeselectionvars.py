...
def make_selection_vars( indo, ismc,
    ...
    dlanavars._shower1_start_2d_U_X[0] = int(vtxShowerData["shower_start_2d"][0][0])       if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower1_start_2d_U_Y[0] = int(vtxShowerData["shower_start_2d"][0][1])       if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower1_start_2d_V_X[0] = int(vtxShowerData["shower_start_2d"][1][0])       if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower1_start_2d_V_Y[0] = int(vtxShowerData["shower_start_2d"][1][1])       if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower1_start_2d_Y_X[0] = int(vtxShowerData["shower_start_2d"][2][0])       if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower1_start_2d_Y_Y[0] = int(vtxShowerData["shower_start_2d"][2][1])       if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower1_impact[0]   = float(vtxShowerData["shower_impact"][0])       if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower1_smallq_U[0] = float(vtxShowerData["shower_smallq"][0])       if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower1_smallq_V[0] = float(vtxShowerData["shower_smallq"][1])       if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower1_smallq_Y[0] = float(vtxShowerData["shower_smallq"][2])       if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower1_sumq_U[0]   = float(vtxShowerData["shower_sumQs"][0])       if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower1_sumq_V[0]   = float(vtxShowerData["shower_sumQs"][1])       if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower1_sumq_Y[0]   = float(vtxShowerData["shower_sumQs"][2])       if PassSimpleCuts and PassShowerReco else -99999
    ...
    dlanavars._shower2_start_2d_U_X[0] = int(vtxShowerData["secondshower_start_2d"][0][0])       if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower2_start_2d_U_Y[0] = int(vtxShowerData["secondshower_start_2d"][0][1])       if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower2_start_2d_V_X[0] = int(vtxShowerData["secondshower_start_2d"][1][0])       if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower2_start_2d_V_Y[0] = int(vtxShowerData["secondshower_start_2d"][1][1])       if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower2_start_2d_Y_X[0] = int(vtxShowerData["secondshower_start_2d"][2][0])       if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower2_start_2d_Y_Y[0] = int(vtxShowerData["secondshower_start_2d"][2][1])       if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower2_impact[0]   = float(vtxShowerData["secondshower_impact"][0])       if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower2_smallq_U[0] = float(vtxShowerData["secondshower_smallq"][0])       if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower2_smallq_V[0] = float(vtxShowerData["secondshower_smallq"][1])       if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower2_smallq_Y[0] = float(vtxShowerData["secondshower_smallq"][2])       if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower2_sumq_U[0]   = float(vtxShowerData["secondshower_sumQs"][0])        if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower2_sumq_V[0]   = float(vtxShowerData["secondshower_sumQs"][1])        if PassSimpleCuts and PassShowerReco else -99999
    dlanavars._shower2_sumq_Y[0]   = float(vtxShowerData["secondshower_sumQs"][2])        if PassSimpleCuts and PassShowerReco else -99999
    ...
    if ismc and PassShowerReco:
        ...
        dlanavars._seconddirection_true_X[0]          = float(vtxShowerData["second_direction_true"][0]) if (dlanavars._numshowers[0] == 2 and dlanavars._truefid[0]) else -9999
        dlanavars._seconddirection_true_Y[0]          = float(vtxShowerData["second_direction_true"][1]) if (dlanavars._numshowers[0] == 2 and dlanavars._truefid[0]) else -9999
        dlanavars._seconddirection_true_Z[0]          = float(vtxShowerData["second_direction_true"][2]) if (dlanavars._numshowers[0] == 2 and dlanavars._truefid[0]) else -9999
        dlanavars._firstdirection_true_X[0]           = float(vtxShowerData["first_direction_true"][0]) if ((dlanavars._numshowers[0] == 2 or dlanavars._numshowers[0] == 1) and dlanavars._truefid[0]) else -9999
        dlanavars._firstdirection_true_Y[0]           = float(vtxShowerData["first_direction_true"][1]) if ((dlanavars._numshowers[0] == 2 or dlanavars._numshowers[0] == 1) and dlanavars._truefid[0]) else -9999
        dlanavars._firstdirection_true_Z[0]           = float(vtxShowerData["first_direction_true"][2]) if ((dlanavars._numshowers[0] == 2 or dlanavars._numshowers[0] == 1) and dlanavars._truefid[0]) else -9999
        dlanavars._shower_start_2d_true_row[0]        = int(vtxShowerData["shower_start_2d_true"][0]) if ((dlanavars._numshowers[0] == 2 or dlanavars._numshowers[0] == 1) and dlanavars._truefid[0]) else -9999
        dlanavars._shower_start_2d_true_colU[0]       = int(vtxShowerData["shower_start_2d_true"][1]) if ((dlanavars._numshowers[0] == 2 or dlanavars._numshowers[0] == 1) and dlanavars._truefid[0]) else -9999
        dlanavars._shower_start_2d_true_colY[0]       = int(vtxShowerData["shower_start_2d_true"][3]) if ((dlanavars._numshowers[0] == 2 or dlanavars._numshowers[0] == 1) and dlanavars._truefid[0]) else -9999
        dlanavars._shower_start_2d_true_colV[0]       = int(vtxShowerData["shower_start_2d_true"][2]) if ((dlanavars._numshowers[0] == 2 or dlanavars._numshowers[0] == 1) and dlanavars._truefid[0]) else -9999
        dlanavars._secondshower_start_2d_true_row[0]  = int(vtxShowerData["secondshower_start_2d_true"][0]) if (dlanavars._numshowers[0] == 2 and dlanavars._truefid[0]) else -9999
        dlanavars._secondshower_start_2d_true_colU[0] = int(vtxShowerData["secondshower_start_2d_true"][1]) if (dlanavars._numshowers[0] == 2 and dlanavars._truefid[0]) else -9999
